#ifndef CAFFE_ACT_CUBOID_LOSS_LAYER_HPP_
#define CAFFE_ACT_CUBOID_LOSS_LAYER_HPP_
...
class ACTCuboidLossLayer : public LossLayer<Dtype> {
 public:
  explicit ACTCuboidLossLayer(const LayerParameter& param)
 ...
 protected:
  ...
  // ACT-detector
  ACTCuboidLossParameter act_cuboid_loss_param_;
  ...
  // ACT-detector: number of sequences
  int num_; 
...
#endif  // CAFFE_ACT_CUBOID_LOSS_LAYER_HPP_
